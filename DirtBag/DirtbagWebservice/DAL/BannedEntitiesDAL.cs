...
namespace DirtBagWebservice.DAL {
    /// <summary>
    /// DEPRECATED For TSB instead DO NOT USE
    /// </summary>
    class BannedEntities {
        private string postgresConnString;
        public BannedEntities(IConfigurationRoot config ) {
            postgresConnString = config.GetConnectionString("BotBanConnectionString");
        }
